...
import caseRoutes from './routes/case.mjs'
...
import caseTransitionRoutes from './routes/caseTransition.mjs';
...
app.use('/casetransition', caseTransitionRoutes);
